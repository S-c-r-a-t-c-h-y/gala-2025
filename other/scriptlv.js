...
$(document).ready(function () {
  ...
  var right = function (question, answer) {
    ...
    for (var i = 0; i < question.length; i++) {
      ...
      if (question[i].answer === answer[i]) {
        display.correct++;
        paraq = $('<p class="outputp1" style="color:#b7ffaf;">', {
          class: "success",
        });
        ...
        paraq = $('<p class="outputp1" style="color:#ff6767;">', {
          class: "error",
        });
        paraq.append(
  ...
  var display = function () {
    if (display.index < q_array.length) {
      ...
      var paraq = $('<p style = "background : rgba(253,76,129,0.9)">').append(
  ...
  unblurq1.on("click", function () {
    $(".outputp1").css("filter", "blur(0px)");
    unblurq1.css("display", "none");
  });
